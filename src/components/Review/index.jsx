  ...
  return (
    <div
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full text-white text-center px-4 md:px-6">
        <h2 className="text-2xl md:text-4xl font-bold mb-4 font-libre_baskerville">Review</h2>
        <hr className="bg-white border-0 my-4 h-1 mx-auto w-24 md:w-48"/>
        <div className={`transition-transform duration-500 ${slide ? 'transform translate-x-0' : 'transform -translate-x-full'}`}>
          <p className="text-base md:text-xl italic mb-4 font-poppins">&quot;{reviews[currentIndex].text}&quot;</p>
          <p className="text-sm md:text-lg font-semibold font-poppins">- {reviews[currentIndex].author}</p>
        </div>
