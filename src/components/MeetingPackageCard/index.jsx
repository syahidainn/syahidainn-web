    ...
    <div className="bg-white p-8 rounded-lg shadow-lg">
      ...
      >
        ...
        <div className={`w-12 h-12 rounded-full bg-[#AE9578] flex items-center justify-center transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`}>
          <span className="text-white text-xl font-bold"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${isExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
        <div>
          <div className="flex items-baseline gap-2 mb-6">
            <span className="text-3xl font-poppins font-semibold text-[#AE9578]">{price}</span>
          ...
          <button className="w-full mt-8 p-3 bg-[#AE9578] text-white font-poppins font-semibold rounded hover:bg-[#9c836a] transition-colors">
            Book Now
          </button>
        </div>
      </div>
